 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://servs/", wsdlLocation = "http://localhost:8080/SoapCalculator/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://servs/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SoapCalculator/CalculatorService?wsdl");
    ...
    public CalculatorInterface getCalculatorServicePort() {
        return super.getPort(new QName("http://servs/", "CalculatorServicePort"), CalculatorInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "CalculatorServicePort")
    public CalculatorInterface getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servs/", "CalculatorServicePort"), CalculatorInterface.class, features);
    }
